---
layout: single
title: "Basic knowledge of Docker"
date: 2025-11-16
categories: [Docker]
...
- [what is Docker](#what-is-docker)
  ...
  - [How this all works together](#how-this-all-works-together)
  - [Docker Core Concepts. ](#docker-core-concepts-)
  - [Docker Setup](#docker-setup)
    - [install docker on linux follow below instructor link.](#install-docker-on-linux-follow-below-instructor-link)
    - [install docker engine](#install-docker-engine)
- [Basic Docker commands](#basic-docker-commands)
  - [List all running containers](#list-all-running-containers)
  - [List all running and stopped containers](#list-all-running-and-stopped-containers)
  - [List all docker images](#list-all-docker-images)
  - [pull docker images](#pull-docker-images)
  - [run docker](#run-docker)
  - [docker logs](#docker-logs)
  - [stop running docker](#stop-running-docker)
...
- [Docker volume and bind mounts](#docker-volume-and-bind-mounts)
  - [Named volumes (Add -v command)(the name here is feedback which could be anything)](#named-volumes-add--v-commandthe-name-here-is-feedback-which-could-be-anything)
  - [remove unuse volume](#remove-unuse-volume)
  ...
  - [working with Environment variable \& ".env"](#working-with-environment-variable--env)
  - [Using Build Arguments (ARG)](#using-build-arguments-arg)
- [create container network](#create-container-network)
  ...
  - [create container network](#create-container-network-1)
  - [Docker Network Drivers](#docker-network-drivers)
- [Build multi application with docker](#build-multi-application-with-docker)
  - [dockerizing mongo database service. ](#dockerizing-mongo-database-service-)
  - [dockerizing backend server](#dockerizing-backend-server)
  - [dockerizing front end server ](#dockerizing-front-end-server-)
  - [make docker networks](#make-docker-networks)
  - [Development vs Production/ Deployment](#development-vs-production-deployment)
  - [Room for Improvement](#room-for-improvement)
- [What is Docker compose](#what-is-docker-compose)
- [Why we need Docker compose](#why-we-need-docker-compose)
- [What Docker Compose is NOT](#what-docker-compose-is-not)
- [Writing Docker Compose Files](#writing-docker-compose-files)
  ...
  - [:bell: Docker Compose Key Commands](#bell-docker-compose-key-commands)
- [What are Utility Containers](#what-are-utility-containers)
  - [Different ways of running command in Container](#different-ways-of-running-command-in-container)
- [The target setup](#the-target-setup)
  - [docker compose file](#docker-compose-file)
  - [run composer utility container to generate the source code of our application](#run-composer-utility-container-to-generate-the-source-code-of-our-application)
  - [Run docker utility artisan to migrate the database](#run-docker-utility-artisan-to-migrate-the-database)
- [Why we need docker](#why-we-need-docker)
- [Development to Production: Things To Watch Out For](#development-to-production-things-to-watch-out-for)
- [Bind Mounts, Volumes \& COPY](#bind-mounts-volumes--copy)
- [A Basic First example: Standalone Nodejs App](#a-basic-first-example-standalone-nodejs-app)
  - [Hosting providers](#hosting-providers)
  - [deploy to AWS EC2](#deploy-to-aws-ec2)
  - [create AWS EC2 instance](#create-aws-ec2-instance)
  - [Deloy Source code vs image](#deloy-source-code-vs-image)
- [managing and updating the Container](#managing-and-updating-the-container)
...
## Docker Core Concepts. <br>

![image](https://user-images.githubusercontent.com/34083808/188259215-1df9ea90-3577-4b73-86e3-f794c156bb38.png)
